			<?php
				...
				$sliderMainSettings->startBulkControl("source_type", UniteSettingsRev::CONTROL_TYPE_SHOW, "posts");
					...
					$sliderMainSettings->addSelect("prd_img_size", $GetArrImageSize, RevsliderPrestashop::$lang['Product_Image_Type'],'large_default');
					//End set IMages Size
				...
				$sliderMainSettings->addRadio("slider_type", array("fixed"=>RevsliderPrestashop::$lang['Fixed'],
					...
					),RevsliderPrestashop::$lang['Slider_Layout'],		
					"fullwidth");
