	...
	class UniteSettingsRevProductRev extends UniteSettingsOutputRev{
		...
		protected function drawHiddenInput($setting) {
			...
			?>
				...
				<input type="hidden" <?php echo $class?> <?php echo $style?> <?php echo $disabled?><?php echo $readonly?> id="<?php echo $setting["id"]?>" name="<?php echo $setting["name"]?>" value="<?php echo $setting["value"]?>" />
		...
		protected function drawSettingRow($setting){
			...
			?>
				...
				<tr id="<?php echo $setting["id_row"]?>" <?php echo $rowStyle ?> <?php echo $class?> valign="top">
                                    ...
                                    <?php if($setting['type'] == UniteSettingsRev::TYPE_HIDDEN){?>
                                        <td colspan="3" <?php echo $cellStyle?>>
                                        <?php 
