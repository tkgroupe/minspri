<?php
	class RevSliderOutput{
		...
		private function putSlides($doWrapFromTemplate){
			...
			if($doWrapFromTemplate !== false)	$this->slider->initByMixed($doWrapFromTemplate);
			...
			if($doWrapFromTemplate)	$this->slider->initByMixed($this->slider->getParam("slider_template_id",false));
				...
				if($this->slider->getParam("load_googlefont","false") == "true"){
					...
					if(is_array($googleFont)){
						...
						$htmlBeforeSlider .= RevOperations::getCleanFontImport($googleFont);
                                        ...
                                        $htmlBeforeSlider = html_entity_decode($htmlBeforeSlider);
